 ...
 * Section 411(a)(2)(B) minimums — keep the two in step.
 *
...
export const VEST_SCHEDULES: Record<ScheduleType, Array<Row & { minPct: number }>> = {
  ...
  // QACA safe harbor money only — Section 401(k)(13)(D)(iii). Never offered as the
  // plan-wide schedule; irsVestingFloor.ts rejects it for any other source.
  "2cliff": [
    { yearLabel: "Less than 1", pct: 0, minPct: 0 },
    { yearLabel: "1", pct: 0, minPct: 0 },
    { yearLabel: "2+", pct: 100, minPct: 100 },
  ],
  "6graded": [
    { yearLabel: "Less than 1", pct: 0, minPct: 0 },
    { yearLabel: "1", pct: 0, minPct: 0 },
